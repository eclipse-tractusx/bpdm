...
interface IBaseBusinessPartner {
    ...
    val identifiers: Collection<IBusinessPartnerIdentifier>
    ...
    val states: Collection<IBusinessPartnerState>
...
interface IBaseLegalEntityRepresentation {
    ...
    val classifications: Collection<IBusinessPartnerClassification>
}
...
interface IBaseAddressRepresentation : IBaseBusinessPartnerPostalAddress {
    ...
    override val physicalPostalAddress: IBasePhysicalPostalAddress?
    ...
    override val alternativePostalAddress: IBaseAlternativePostalAddress?
}