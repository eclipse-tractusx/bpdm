...
data class LegalEntityDtoV6(
    ...
    override val identifiers: Collection<LegalEntityIdentifierDtoV6> = emptyList(),
    override val states: Collection<LegalEntityStateDtoV6> = emptyList(),
