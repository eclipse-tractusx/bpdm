...
@Schema(description = LegalEntityDescription.headerUpdateRequest, deprecated = true)
data class LegalEntityPartnerUpdateRequestV6(

    @get:Schema(description = LegalEntityDescription.bpnl)
    val bpnl: String,

    @field:JsonUnwrapped
    val legalEntity: LegalEntityDtoV6,

    // TODO OpenAPI description for complex field does not work!!
    @get:Schema(description = LegalEntityDescription.legalAddress)
    val legalAddress: LogisticAddressDtoV6
