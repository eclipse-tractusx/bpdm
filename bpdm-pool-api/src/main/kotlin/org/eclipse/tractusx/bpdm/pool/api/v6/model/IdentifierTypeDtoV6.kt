...
@Schema(description = IdentifierTypeDescription.header, deprecated = true)
data class IdentifierTypeDtoV6(
    ...
    val details: Collection<IdentifierTypeDetailDtoV6> = listOf()
)
