...
@Schema(description = SiteDescription.header, deprecated = true)
data class SiteVerboseDtoV6(

    @get:Schema(description = SiteDescription.bpns)
    val bpns: String,

    override val name: String,
    override val states: Collection<SiteStateVerboseDtoV6> = emptyList(),

    @get:Schema(description = "Indicates whether the site is owned and thus provided by a Catena-X Member.", name = "isCatenaXMemberData")
