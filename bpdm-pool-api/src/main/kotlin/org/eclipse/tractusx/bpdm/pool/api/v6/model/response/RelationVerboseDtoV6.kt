...
@Schema(name = "RelationVerboseDtoV6", description = "Directed relation between two business partners", deprecated = true)
data class RelationVerboseDtoV6(
    @get:Schema(description = "The type of relation between the Legal Entities")
    val type: LegalEntityRelationTypeV6,
