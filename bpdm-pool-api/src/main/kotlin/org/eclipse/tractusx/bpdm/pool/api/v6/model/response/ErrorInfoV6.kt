...
@Schema(title = "ErrorInfoV6", description = "Holds information about failures when creating or updating an entity", deprecated = true)
data class ErrorInfoV6<out ERROR : ErrorCodeV6>(
