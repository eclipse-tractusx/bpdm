...
@Schema(description = PostalAddressDescription.headerPhysical, deprecated = true)
data class PhysicalPostalAddressVerboseDtoV6(
    ...
    val administrativeAreaLevel1Verbose: RegionDtoV6?,
    ...
    override val street: StreetDtoV6?,
