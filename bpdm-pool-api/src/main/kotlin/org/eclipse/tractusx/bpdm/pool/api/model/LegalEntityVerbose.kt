...
data class LegalEntityVerbose(
    ...
    val legalFormVerbose: LegalForm? = null,

    override val identifiers: Collection<LegalEntityIdentifierVerbose> = emptyList(),
    override val states: Collection<LegalEntityStateVerbose> = emptyList(),
    override val classifications: Collection<LegalEntityClassificationVerbose> = emptyList(),

    @get:ArraySchema(arraySchema = Schema(description = LegalEntityDescription.relations))
    val relations: Collection<RelationVerbose> = emptyList(),
