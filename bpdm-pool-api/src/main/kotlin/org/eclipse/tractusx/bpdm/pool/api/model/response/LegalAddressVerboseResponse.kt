...
import org.eclipse.tractusx.bpdm.pool.api.model.PhysicalPostalAddressVerbose
import java.time.Instant

@Schema(name = "LegalAddressVerboseResponse", description = "Legal address for legal entity")
data class LegalAddressVerboseResponse(

    @Schema(description = "Physical postal address")
    val physicalPostalAddress: PhysicalPostalAddressVerbose,
