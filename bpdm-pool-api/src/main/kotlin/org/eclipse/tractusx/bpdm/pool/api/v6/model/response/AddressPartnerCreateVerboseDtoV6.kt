...
@Schema(description = LogisticAddressDescription.headerCreateResponse, deprecated = true)
data class AddressPartnerCreateVerboseDtoV6(

    @field:JsonUnwrapped
    val address: LogisticAddressVerboseDtoV6,
