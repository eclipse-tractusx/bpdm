...
@Schema(description = LegalEntityDescription.header, deprecated = true)
data class LegalEntityVerboseDtoV6(
    ...
    val legalFormVerbose: LegalFormDtoV6? = null,

    override val identifiers: Collection<LegalEntityIdentifierVerboseDtoV6> = emptyList(),
    override val states: Collection<LegalEntityStateVerboseDtoV6> = emptyList(),

    @get:ArraySchema(arraySchema = Schema(description = LegalEntityDescription.relations))
    val relations: Collection<RelationVerboseDtoV6> = emptyList(),
