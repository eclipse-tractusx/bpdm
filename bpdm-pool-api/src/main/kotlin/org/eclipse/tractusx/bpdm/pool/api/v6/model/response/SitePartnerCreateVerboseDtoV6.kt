...
@Schema(description = SiteDescription.headerUpsertResponse, deprecated = true)
data class SitePartnerCreateVerboseDtoV6(

    @field:JsonUnwrapped
    val site: SiteVerboseDtoV6,

    // TODO OpenAPI description for complex field does not work!!
    @get:Schema(description = SiteDescription.mainAddress)
    val mainAddress: LogisticAddressVerboseDtoV6,
