...
@Schema(description = LegalEntityDescription.headerUpsertResponse, deprecated = true)
data class LegalEntityPartnerCreateVerboseDtoV6(

    @field:JsonUnwrapped
    val legalEntity: LegalEntityVerboseDtoV6,

    // TODO OpenAPI description for complex field does not work!!
    @get:Schema(description = LegalEntityDescription.legalAddress)
    val legalAddress: LogisticAddressVerboseDtoV6,
