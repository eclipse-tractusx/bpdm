...
@Schema(description = LogisticAddressDescription.header, deprecated = true)
data class LogisticAddressVerboseDtoV6(
    ...
    override val states: Collection<AddressStateVerboseDtoV6> = emptyList(),
    override val identifiers: Collection<AddressIdentifierVerboseDtoV6> = emptyList(),
    override val physicalPostalAddress: PhysicalPostalAddressVerboseDtoV6,
    override val alternativePostalAddress: AlternativePostalAddressVerboseDtoV6? = null,
