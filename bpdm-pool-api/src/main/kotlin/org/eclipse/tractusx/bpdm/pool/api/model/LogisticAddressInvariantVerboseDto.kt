...
data class LogisticAddressInvariantVerboseDto(
    ...
    @get:Schema(description = "Indicates whether the address is owned and thus provided by a Data Space Participant.", name = "isParticipantData")
