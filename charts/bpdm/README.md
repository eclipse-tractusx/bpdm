...
![Version: 7.0.0-rc2](https://img.shields.io/badge/Version-7.0.0--rc2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.4.0-rc2](https://img.shields.io/badge/AppVersion-7.4.0--rc2-informational?style=flat-square)
...
|------------|------|---------|
|  | bpdm-cleaning-service-dummy(bpdm-cleaning-service-dummy) | 5.0.0-rc2 |
|  | bpdm-common | 2.0.0 |
|  | bpdm-gate(bpdm-gate) | 8.0.0-rc2 |
|  | bpdm-orchestrator(bpdm-orchestrator) | 5.0.0-rc2 |
|  | bpdm-pool(bpdm-pool) | 9.0.0-rc2 |
