...
![Version: 6.3.0-rc2](https://img.shields.io/badge/Version-6.3.0--rc2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.3.0-rc2](https://img.shields.io/badge/AppVersion-7.3.0--rc2-informational?style=flat-square)
...
|------------|------|---------|
|  | bpdm-cleaning-service-dummy(bpdm-cleaning-service-dummy) | 4.3.0-rc2 |
|  | bpdm-common | 1.0.5 |
|  | bpdm-gate(bpdm-gate) | 7.3.0-rc2 |
|  | bpdm-orchestrator(bpdm-orchestrator) | 4.3.0-rc2 |
|  | bpdm-pool(bpdm-pool) | 8.3.0-rc2 |
