...
|------------|------|---------|
|  | bpdm-cleaning-service-dummy(bpdm-cleaning-service-dummy) | 5.0.0-SNAPSHOT |
|  | bpdm-common | 2.0.0 |
|  | bpdm-gate(bpdm-gate) | 8.0.0-SNAPSHOT |
|  | bpdm-orchestrator(bpdm-orchestrator) | 5.0.0-SNAPSHOT |
|  | bpdm-pool(bpdm-pool) | 9.0.0-SNAPSHOT |
...
| keycloak.keycloak.adminPassword | string | `"admin"` |  |
...
| tests.applicationConfig.bpdm.client.gate.provider.issuer-uri | string | `"http://bpdm-keycloak/realms/BPDM"` |  |
| tests.applicationConfig.bpdm.client.orchestrator.provider.issuer-uri | string | `"http://bpdm-keycloak/realms/BPDM"` |  |
| tests.applicationConfig.bpdm.client.pool.provider.issuer-uri | string | `"http://bpdm-keycloak/realms/BPDM"` |  |
