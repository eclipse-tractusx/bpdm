...
![Version: 6.0.0-SNAPSHOT](https://img.shields.io/badge/Version-6.0.0--SNAPSHOT-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.0.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.0.0--SNAPSHOT-informational?style=flat-square)
...
|------------|------|---------|
|  | bpdm-cleaning-service-dummy(bpdm-cleaning-service-dummy) | 4.0.0-SNAPSHOT |
|  | bpdm-common | 1.0.4-SNAPSHOT |
|  | bpdm-gate(bpdm-gate) | 7.0.0-SNAPSHOT |
|  | bpdm-orchestrator(bpdm-orchestrator) | 4.0.0-SNAPSHOT |
|  | bpdm-pool(bpdm-pool) | 8.0.0-SNAPSHOT |
