...
![Version: 6.2.0-rc2](https://img.shields.io/badge/Version-6.2.0--rc2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.2.0-rc2](https://img.shields.io/badge/AppVersion-7.2.0--rc2-informational?style=flat-square)
...
|------------|------|---------|
|  | bpdm-cleaning-service-dummy(bpdm-cleaning-service-dummy) | 4.2.0-rc2 |
|  | bpdm-common | 1.0.5 |
|  | bpdm-gate(bpdm-gate) | 7.2.0-rc2 |
|  | bpdm-orchestrator(bpdm-orchestrator) | 4.2.0-rc2 |
|  | bpdm-pool(bpdm-pool) | 8.2.0-rc2 |
