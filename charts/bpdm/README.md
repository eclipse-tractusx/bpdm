...
![Version: 7.2.0-SNAPSHOT](https://img.shields.io/badge/Version-7.2.0--SNAPSHOT-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 7.6.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-7.6.0--SNAPSHOT-informational?style=flat-square)
...
|------------|------|---------|
|  | bpdm-cleaning-service-dummy(bpdm-cleaning-service-dummy) | 5.2.0-SNAPSHOT |
|  | bpdm-common | 2.0.0 |
|  | bpdm-gate(bpdm-gate) | 8.2.0-SNAPSHOT |
|  | bpdm-orchestrator(bpdm-orchestrator) | 5.2.0-SNAPSHOT |
|  | bpdm-pool(bpdm-pool) | 9.2.0-SNAPSHOT |
