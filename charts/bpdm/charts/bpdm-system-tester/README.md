...
![Version: 1.0.0-SNAPSHOT](https://img.shields.io/badge/Version-1.0.0--SNAPSHOT-informational?style=flat-square) ![AppVersion: 6.3.0-SNAPSHOT](https://img.shields.io/badge/AppVersion-6.3.0--SNAPSHOT-informational?style=flat-square)

A Helm chart for deploying the BPDM System tester service
...
| image.repository | string | `"tractusx/bpdm-system-tester"` |  |
| image.tag | string | `""` |  |
