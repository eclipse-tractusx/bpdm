...
VALUES
    (nextval('bpdm_sequence'), gen_random_uuid(), now(), now(), 'HEADQUARTER_RELOCATION',             'Complete relocation of a legal entity headquarter to a new physical location'),
    (nextval('bpdm_sequence'), gen_random_uuid(), now(), now(), 'SITE_RELOCATION',                    'Complete relocation of a site to a new physical location'),
