...
/**
 * Queries the reason codes a business partner relation may state.
 */
@Service
class ReasonCodeSearchService(
    private val reasonCodeRepository: ReasonCodeRepository
) {

    /**
     * Returns the requested page of all known reason codes.
     */
    @Transactional(readOnly = true)
    fun search(pageable: Pageable): Page<ReasonCodeDb> =
        reasonCodeRepository.findAll(pageable)
}
