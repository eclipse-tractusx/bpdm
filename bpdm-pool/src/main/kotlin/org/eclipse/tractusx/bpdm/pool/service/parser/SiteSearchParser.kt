...
/**
 * Turns loose site search criteria into the normalized form the search operation queries with.
 *
...
class SiteSearchParser(
     ...
     */
    fun parse(request: SiteSearchRequest): SiteSearchParsed =
        SiteSearchParsed(
