...
interface LegalEntityIdentifierRepository : CrudRepository<LegalEntityIdentifierDb, Long> {
    ...
    @Query("SELECT new org.eclipse.tractusx.bpdm.pool.model.BpnIdentifierMatch(i.value,i.legalEntity.bpn) FROM LegalEntityIdentifierDb i WHERE i.type = :identifierType AND i.value in :values")
