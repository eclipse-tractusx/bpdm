...
/**
 * Maps the legal form parser's sealed parse errors to the errors the legal form endpoints report them with.
 */
@Component
class LegalFormParseErrorMapper {
    ...
    private fun toValidationError(error: UnresolvableAdministrativeArea): ValidationError =
        ValidationError(
            ...
            context = ValidationContext.fromRoot(LegalFormRequestDto::class, "request", LegalFormRequestDto::administrativeAreaLevel1)
        )
}
