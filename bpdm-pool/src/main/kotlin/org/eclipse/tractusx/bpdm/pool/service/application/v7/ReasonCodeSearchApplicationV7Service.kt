...
/**
 * The REST-API boundary for the V7 "search reason codes" operation.
 */
@Service
class ReasonCodeSearchApplicationV7Service(
    private val reasonCodeSearchService: ReasonCodeSearchService
) {
