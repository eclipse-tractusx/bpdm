...
/**
 * Maps stored legal forms to the v6 API legal form DTOs.
 */
@Component
class LegalFormResponseMapperV6 {

    /**
     * Returns the given legal form as the v6 API reports it.
     */
    fun toLegalForm(legalForm: LegalFormDb): LegalFormDtoV6 =
        with(legalForm) {
            LegalFormDtoV6(
