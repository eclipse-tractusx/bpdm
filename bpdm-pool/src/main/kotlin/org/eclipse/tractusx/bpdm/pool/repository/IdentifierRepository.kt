...
interface IdentifierRepository : CrudRepository<Identifier, Long> {
    ...
    @Query("SELECT new org.eclipse.tractusx.bpdm.pool.api.dto.response.BpnIdentifierMappingResponse(i.value,i.legalEntity.bpn) FROM Identifier i WHERE i.type = :identifierType AND i.value in :values")
