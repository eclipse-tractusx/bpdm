...
class AddressController(
    ...
    @GetMapping
    fun getAddresses(
        @ParameterObject @ModelAttribute(name = "addressSearchRequest") addressSearchRequest: AddressPartnerSearchRequest,
        @ParameterObject @ModelAttribute(name = "paginationRequest") paginationRequest: PaginationRequest
    ...
    fun getAddresses2(
        ...
        return searchService.searchAddresses(AddressPartnerSearchRequest.EmptySearchRequest, paginationRequest).toString()
    }
