...
/**
 * Queries the script codes a business partner may be written in.
 */
@Service
class ScriptCodeSearchService(
    ...
    fun search(pageable: Pageable): Page<ScriptCodeDb> =
        scriptCodeRepository.findAll(pageable)
}
