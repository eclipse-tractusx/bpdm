...
/**
 * Resolves legal-entity BPNs to entities, batched and order-preserving (see [ParseResult]): an unresolvable BPN yields
 * an [UnresolvableLegalEntity] for that entry. Single responsibility so any service needing a legal-entity parent can
