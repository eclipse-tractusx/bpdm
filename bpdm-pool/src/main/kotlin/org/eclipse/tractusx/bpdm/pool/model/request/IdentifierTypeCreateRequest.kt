...
data class IdentifierTypeCreateRequest(
    ...
    val format: String?,
    val categories: Set<IdentifierTypeCategory>,
    val details: List<IdentifierTypeDetailRequest>
)

data class IdentifierTypeDetailRequest(
