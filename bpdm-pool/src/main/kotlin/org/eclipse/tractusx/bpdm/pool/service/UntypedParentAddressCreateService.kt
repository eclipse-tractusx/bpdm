 ...
 * [AdditionalAddressCreateService] expects — reporting the precise [InvalidParentBpn]/[UnresolvableLegalEntity]/
 * [UnresolvableSite] errors that the typed stage cannot distinguish (see [AddressParentResolutionParser]) — then
