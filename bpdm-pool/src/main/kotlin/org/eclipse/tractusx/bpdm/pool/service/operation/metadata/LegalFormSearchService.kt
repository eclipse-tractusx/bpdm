...
/**
 * Queries the legal forms legal entities may be registered under.
 */
@Service
class LegalFormSearchService(
    ...
    fun search(pageable: Pageable): Page<LegalFormDb> =
        legalFormRepository.findAll(pageable)
}
