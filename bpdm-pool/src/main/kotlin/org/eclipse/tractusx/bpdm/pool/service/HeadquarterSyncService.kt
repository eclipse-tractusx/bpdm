...
import org.eclipse.tractusx.bpdm.pool.service.operation.ScriptVariantCoherenceService
...
class HeadquarterSyncService(
    ...
    private val scriptVariantCoherenceService: ScriptVariantCoherenceService,
    ...
    fun synchronizeHeadquarter(legalEntityDb: LegalEntityDb){
        ...
        if(newLegalAddress != null){
            ...
            scriptVariantCoherenceService.pruneUnrenderedScriptVariants(legalEntityDb)
