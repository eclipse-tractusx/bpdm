...
@Configuration
class PoolAssertV7Configuration {
    ...
    @Bean
    fun poolAsserRepositoryV7(instantSecondsComparator: InstantSecondsComparator, localDatetimeSecondsComparator: LocalDatetimeSecondsComparator): AssertRepositoryV7{
        return AssertRepositoryV7(instantSecondsComparator, localDatetimeSecondsComparator)
    }
