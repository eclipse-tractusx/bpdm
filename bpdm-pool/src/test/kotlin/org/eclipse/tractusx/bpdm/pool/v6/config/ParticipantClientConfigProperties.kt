...
import org.eclipse.tractusx.bpdm.pool.v6.config.ParticipantClientConfigProperties.Companion.PREFIX
...
data class ParticipantClientConfigProperties(
    ...
    companion object{
        const val PREFIX = "${ClientConfigurationProperties.PREFIX}.participant"
    }
