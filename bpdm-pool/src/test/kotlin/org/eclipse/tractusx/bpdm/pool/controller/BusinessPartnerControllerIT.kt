    ...
    private fun expectedSite():BusinessPartnerSearchResultDto {
        ...
        return BusinessPartnerSearchResultDto(
            ...
            site = BusinessPartnerSite(
                ...
                states = listOf(BusinessPartnerStateDto(
                    validFrom = BusinessPartnerVerboseValues.leStatus1.validFrom,
                    validTo = BusinessPartnerVerboseValues.leStatus1.validTo,
                    type = BusinessPartnerVerboseValues.leStatus1.type,
                ))
            ),
            address = BusinessPartnerPostalAddress(
