...
class LegalEntityApiOperatorV6AuthTest: OperatorTest(), LegalEntityApiAuthV6Test {
    ...
    override val expectationCreateBusinessPartners = AuthExpectationType.Authorized
    override val expectationUpdateBusinessPartners = AuthExpectationType.Authorized
}