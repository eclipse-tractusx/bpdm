...
import org.eclipse.tractusx.bpdm.pool.v6.config.UnauthorizedClientConfigProperties.Companion.PREFIX
...
data class UnauthorizedClientConfigProperties(
    ...
    companion object{
        const val PREFIX = "${ClientConfigurationProperties.PREFIX}.unauthorized"
    }
