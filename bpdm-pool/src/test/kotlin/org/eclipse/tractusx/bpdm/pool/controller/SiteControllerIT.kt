...
class SiteControllerIT @Autowired constructor(
    ...
    fun `search sites by BPNL`() {
        ...
        val expectedSiteWithReference2 =
            SitePoolResponse(site = ResponseValues.site2.copy(bpnLegalEntity = bpnL1), mainAddress = ResponseValues.addressPartner2)
        val expectedSiteWithReference3 =
            SitePoolResponse(site = ResponseValues.site3.copy(bpnLegalEntity = bpnL2), mainAddress = ResponseValues.addressPartner3)
