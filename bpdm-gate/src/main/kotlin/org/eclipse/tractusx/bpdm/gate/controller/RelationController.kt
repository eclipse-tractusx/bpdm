...
class RelationController(
    ...
    @PreAuthorize("hasAuthority(${PermissionConfigProperties.READ_INPUT_RELATION}) && hasAuthority(@principalUtil.tryResolve(#tenantBpnL))")
    override fun get(
        tenantBpnL: String?,
       ...
       return relationshipService.findRelations(
           tenantBpnL = principalUtil.resolveTenantBpnL(tenantBpnL),
    ...
    @PreAuthorize("hasAuthority(${PermissionConfigProperties.WRITE_INPUT_RELATION}) && hasAuthority(@principalUtil.tryResolve(#requestBody.getTenantBpnL()))")
    override fun post(
        requestBody: RelationPostRequest
    ): RelationDto {
       return relationshipService.createRelation(
           tenantBpnL = principalUtil.resolveTenantBpnL(requestBody.tenantBpnL),
           stageType = StageType.Input,
    ...
    @PreAuthorize("hasAuthority(${PermissionConfigProperties.WRITE_INPUT_RELATION}) && hasAuthority(@principalUtil.tryResolve(#tenantBpnL))")
    override fun delete(tenantBpnL: String?, externalId: String) {
