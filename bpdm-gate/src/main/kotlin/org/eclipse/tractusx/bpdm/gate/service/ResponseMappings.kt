...
fun ChangelogEntry.toGateDto(): ChangelogGateResponse {
...
fun toEntityClassification(dto: LegalEntityClassificationDto, legalEntity: LegalEntityDb): LegalEntityClassificationDb {
...
fun mapToLegalEntityClassificationsDto(classification: MutableSet<LegalEntityClassificationDb>): Collection<LegalEntityClassificationDto> {
