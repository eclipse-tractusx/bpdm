...
import org.eclipse.tractusx.bpdm.gate.client.service.site.GateClientSite
...
internal class SiteControllerInputIT @Autowired constructor(
    ...
    val gateClientSite = GateClientSite(webClient)
    ...
    fun `get site by external id`() {
        ...
        val site = gateClientSite.getSiteByExternalId(SaasValues.siteBusinessPartnerWithRelations1.externalId.toString())
...
//            .responseBody
    ...
    fun `get site by external id, not found`() {
        ...
        try{
            gateClientSite.getSiteByExternalId("nonexistent-externalid123")
...
//            .isNotFound
    ...
    fun `get site by external id, SaaS error`() {
        ...
        try{
            gateClientSite.getSiteByExternalId(SaasValues.legalEntity1.externalId.toString())
        }catch (e: WebClientResponseException){
...
//            .is5xxServerError
    ...
    fun `get site without main address, expect error`() {
        ...
        try{
            gateClientSite.getSiteByExternalId(SaasValues.siteBusinessPartnerWithRelations1.externalId.toString())
        }catch (e: WebClientResponseException){
            val statusCode: HttpStatusCode = e.statusCode
            val statusCodeValue: Int = statusCode.value()
            assertTrue(statusCodeValue in 500..599)
...
//            .is5xxServerError
    ...
    fun `get sites`() {
        ...
        val pageResponse = gateClientSite.getSites(paginationValue)
...
//            .blockFirst()!!
    ...
    fun `get sites, SaaS error`() {
        ...
        try{
            gateClientSite.getSites(paginationValue)
        }catch (e: WebClientResponseException){
            val statusCode: HttpStatusCode = e.statusCode
            val statusCodeValue: Int = statusCode.value()
            assertTrue(statusCodeValue in 500..599)
...
//            .is5xxServerError
    ...
    fun `upsert sites`() {
        ...
        try{
            gateClientSite.upsertSites(sites)
        }catch (e: WebClientResponseException){
...
//            .isBadRequest
    ...
    fun `validate a valid site`() {
        ...
        val actualResponse = gateClientSite.validateSite(site)
