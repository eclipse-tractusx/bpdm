...
class BusinessPartnerControllerIT @Autowired constructor(
    ...
    val gateClientBusinessPartner = GateClientBusinessPartner(webClient)
    ...
    fun `match legal entity type`() {
        ...
        val typeResponseValue = gateClientBusinessPartner.getAddressByExternalId(givenCandidate)
    ...
    fun `accept candidate without name`() {
        ...
        try{
            gateClientBusinessPartner.getAddressByExternalId(givenCandidate)
