...
internal class AddressControllerOutputIT @Autowired constructor(
    ...
    fun `get addresses`() {
        ...
        val pageResponse = gateClientAddress.getAddressesOutput(paginationValue, null)
    ...
    fun `get addresses, filter by external ids`() {
        ...
        val paginationValue = PaginationStartAfterRequest(startAfter, limit)
        val pageResponse = gateClientAddress.getAddressesOutput(paginationValue, listOf(CommonValues.externalIdAddress1, CommonValues.externalIdAddress2))
