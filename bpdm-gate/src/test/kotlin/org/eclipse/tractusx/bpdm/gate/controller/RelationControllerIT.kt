...
class RelationControllerIT @Autowired constructor(
    ...
    val tenantBpnl = "BPNL00000003CRHK"
    var testName: String = ""
    ...
    fun postRelation(){
        ...
        val response = gateClient.relation.post(
            RelationPostRequest(
        ...
        assertRelation(response, expectation, Timeframe(beforePost, afterPost))
    }

    @Test
    fun postRelationWithLegalAndSiteMainAddresses(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
    ...
    fun postRelationWithTenant(){
        ...
        assertRelation(response, expectation, Timeframe(beforePost, afterPost), ignoreExternalId = true)
    }

    @Test
    fun postRelationWithExternalId(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
    ...
    @Test
    fun postRelationWithMultipleTargets(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
    ...
    @Test
    fun postRelationWithWrongTenant(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
        ...
        Assertions.assertThatExceptionOfType(Forbidden::class.java).isThrownBy {
            gateClient.relation.post(
                RelationPostRequest(
                    externalId = testName,
                    tenantBpnL = "WRONG Tenant",
                    relationType = RelationType.IsManagedBy,
                    businessPartnerSourceExternalId = legalEntityId1,
                    businessPartnerTargetExternalId = legalEntityId2
                )
    ...
    @Test
    fun postRelationWithSourceNotOwnCompanyData(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
    ...
    @Test
    fun postRelationWithTargetNotOwnCompanyData(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
    ...
    @Test
    fun postRelationWithSourceSite(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
    ...
    @Test
    fun postRelationWithTargetSite(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
    ...
    @Test
    fun postRelationWithSourceAdditionalAddress(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
    ...
    @Test
    fun postRelationWithTargetAdditionalAddress(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
    ...
    fun postRelationDuplicateId(){
        ...
        Assertions.assertThatExceptionOfType(Conflict::class.java).isThrownBy {
            gateClient.relation.post(
                RelationPostRequest(
                    externalId = testName,
                    relationType = RelationType.IsManagedBy,
    ...
    @Test
    fun postRelationWithSourceEqualsTarget(){
        val legalEntityId1 = "$testName LE 1"
    ...
    @Test
    fun postRelationWithSourceNotExist(){
        val legalEntityId1 = "$testName LE 1"
        gateClient.businessParters.upsertBusinessPartnersInput(
            listOf(
                createLegalEntityRequest(legalEntityId1)
    ...
    @Test
    fun postRelationWithTargetNotExist(){
        val legalEntityId1 = "$testName LE 1"
        gateClient.businessParters.upsertBusinessPartnersInput(
            listOf(
                createLegalEntityRequest(legalEntityId1)
    ...
    @Test
    fun postRelationMultipleSources(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
        val legalEntityId3 = "$testName LE 3"
    ...
    @Test
    fun postRelationTargetIsAlreadySource(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
        val legalEntityId3 = "$testName LE 3"
    ...
    @Test
    fun postRelationSourceIsAlreadyTarget(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
        val legalEntityId3 = "$testName LE 3"
    ...
    @Test
    fun putUpdateRelationWithMultipleTargets(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
        val legalEntityId3 = "$testName LE 3"
        val legalEntityId4 = "$testName LE 4"
    ...
    @Test
    fun putUpdateRelationWithWrongTenant(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
        val legalEntityId3 = "$testName LE 3"
        val legalEntityId4 = "$testName LE 4"
    ...
    @Test
    fun putUpdateRelationMultipleSources(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
        val legalEntityId3 = "$testName LE 3"
        val legalEntityId4 = "$testName LE 4"
    ...
    @Test
    fun putUpsertRelationWithMultipleTargets(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
        val legalEntityId3 = "$testName LE 3"
        val relationId1 = "$testName Relation 1"
    ...
    @Test
    fun putUpsertRelationWithWrongTenant(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
    ...
    @Test
    fun putUpsertRelationMultipleSources(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
        val legalEntityId3 = "$testName LE 3"
    ...
    fun deleteRelation(){
        ...
        gateClient.relation.delete(externalId = relationId)

        val response = gateClient.relation.get(externalIds = listOf(relationId))
        Assertions.assertThat(response.content).isEmpty()
    }

    @Test
    fun deleteRelationWithTenant(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
        val relationId = "$testName Relation"
        ...
        gateClient.relation.delete(tenantBpnL = tenantBpnl, externalId = relationId)
    ...
    @Test
    fun deleteRelationWithWrongTenant(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
        val relationId = "$testName Relation"
        ...
        Assertions.assertThatExceptionOfType(Forbidden::class.java).isThrownBy {
            gateClient.relation.delete(tenantBpnL = "WRONG TENANT", externalId = relationId)
        }
    }

    @Test
    fun deleteRelationWithIdNotExists(){
        val legalEntityId1 = "$testName LE 1"
        val legalEntityId2 = "$testName LE 2"
        val relationId = "$testName Relation"
        ...
        Assertions.assertThatExceptionOfType(BadRequest::class.java).isThrownBy {
            gateClient.relation.delete(externalId = "NOT EXISTS")
        }
    }
    ...
    fun getRelationsViaSource(){
        ...
        val response = gateClient.relation.get(businessPartnerSourceExternalIds = listOf(legalEntityId1, legalEntityId2))

        val expectation = PageDto(3, 1, 0, 3, postResponses.filter { it.businessPartnerSourceExternalId == legalEntityId1 })
    ...
    fun getRelationsViaTarget(){
        ...
        val response = gateClient.relation.get(businessPartnerTargetExternalIds = listOf(legalEntityId2, legalEntityId3))

        val expectation = PageDto(2, 1, 0, 2, postResponses.filter { it.businessPartnerTargetExternalId in listOf(legalEntityId2, legalEntityId3) })
    ...
    fun getRelationsViaAllFilters(){
        ...
        val response = gateClient.relation.get(
            ...
            relationType = RelationType.IsManagedBy,
            businessPartnerSourceExternalIds = listOf(legalEntityId1),
            businessPartnerTargetExternalIds = listOf(legalEntityId4),
    ...
    fun getRelationsWrongTenant(){
        ...
        Assertions.assertThatExceptionOfType(Forbidden::class.java).isThrownBy{
            gateClient.relation.get(tenantBpnL = "WRONG TENANT")
        }
    }
