...
internal class LegalEntityControllerOutputIT @Autowired constructor(
    ...
    fun `get legal entities`() {
        ...
        val pageResponse = gateClientLegalEntity.getLegalEntitiesOutput(paginationValue, null) //Need to Change externalId
...
//            .blockFirst()!!
    ...
    fun `get legal entities, filter by external ids`() {
        ...
        val paginationValue = PaginationStartAfterRequest(startAfter, limit)
        val pageResponse = gateClientLegalEntity.getLegalEntitiesOutput(paginationValue, listOf(CommonValues.externalId1, CommonValues.externalId2))
