...
abstract class AuthTestBase(
    ...
    @Test
    fun `POST Relations`() {
        authAssertions.assert(authExpectations.relation.post) { gateClient.relation.post(RelationPostRequest(null, null, RelationType.IsManagedBy, "", "")) }
    }

    @Test
    fun `PUT Relations`() {
        authAssertions.assert(authExpectations.relation.put) { gateClient.relation.put(true, RelationPutRequest(null, "", RelationType.IsManagedBy, "", "")) }
    }

    @Test
    fun `DELETE Relations`() {
        authAssertions.assert(authExpectations.relation.delete) { gateClient.relation.delete(null, "") }
    }
