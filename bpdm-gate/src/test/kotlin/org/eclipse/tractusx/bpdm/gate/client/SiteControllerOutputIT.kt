...
internal class SiteControllerOutputIT @Autowired constructor(
    ...
    fun `get sites`() {
        ...
        val pageResponseValue = gateClientSite.getSitesOutput(paginationValue, null)
    ...
    fun `get sites, filter by external ids`() {
        ...
        val paginationValue = PaginationStartAfterRequest(startAfter,limit)
        val pageResponseValue = gateClientSite.getSitesOutput(paginationValue, listOf(CommonValues.externalIdSite1, CommonValues.externalIdSite2))
