...
data class RelationPutRequest(
    @Schema(description = "The BPNL of the tenant in which to update. If not given, the system attempts to infer the tenant from the authentication.")
    override val tenantBpnL: String? = null,
