...
interface ChangelogApiClientV6: GateChangelogApi {
    @PostExchange(value = "${ApiCommons.BASE_PATH_V6}/input/changelog/search")
    ...
    @PostExchange(value = "${ApiCommons.BASE_PATH_V6}/output/changelog/search")
