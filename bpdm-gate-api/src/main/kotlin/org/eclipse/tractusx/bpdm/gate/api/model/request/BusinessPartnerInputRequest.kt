...
data class BusinessPartnerInputRequest(
    ...
    override val identifiers: List<BusinessPartnerIdentifierDto> = emptyList(),
    override val legalForm: String? = null,
    override val states: List<BusinessPartnerStateDto> = emptyList(),
    override val classifications: List<ClassificationDto> = emptyList(),
    override val roles: List<BusinessPartnerRole> = emptyList(),
