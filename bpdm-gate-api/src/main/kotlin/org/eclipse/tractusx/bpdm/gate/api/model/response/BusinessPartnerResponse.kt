...
data class BusinessPartnerInputResponse(
...
data class LegalEntityRepresentationInputResponse(
...
data class SiteRepresentationInputResponse(
    override val siteBpn: String? = null,
    override val name: String? = null
) : IBaseSiteRepresentation

data class AddressRepresentationInputResponse(
