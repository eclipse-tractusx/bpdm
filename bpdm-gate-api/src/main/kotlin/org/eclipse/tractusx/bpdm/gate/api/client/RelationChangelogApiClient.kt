...
@HttpExchange
interface RelationChangelogApiClient: GateRelationChangelogApi {

    @PostExchange(value = "${ApiCommons.BASE_PATH_V7}/input/relations/changelog/search")
    ...
    @PostExchange(value = "${ApiCommons.BASE_PATH_V7}/output/relations/changelog/search")
