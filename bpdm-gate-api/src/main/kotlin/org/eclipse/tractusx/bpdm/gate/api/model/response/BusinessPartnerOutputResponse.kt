...
data class BusinessPartnerOutputResponse(
    ...
    override val legalEntity: LegalEntityRepresentationOutputResponse,
    override val site: SiteRepresentationOutputResponse?,
    override val address: AddressComponentOutputResponse,
...
data class LegalEntityRepresentationOutputResponse(
...
data class SiteRepresentationOutputResponse(
...
data class AddressComponentOutputResponse(
    override val addressBpn: String,
    override val name: String? = null,
    override val addressType: AddressType?,
    override val physicalPostalAddress: PhysicalPostalAddress = PhysicalPostalAddress(),
    override val alternativePostalAddress: AlternativePostalAddress = AlternativePostalAddress(),
    val confidenceCriteria: ConfidenceCriteria
