...
interface StatsApiClientV6: StatsApi {
    @GetExchange(value = "${ApiCommons.STATS_PATH_V6}/sharing-states")
    override fun countPartnersBySharingState(): StatsSharingStatesResponse

    @GetExchange(value = "${ApiCommons.STATS_PATH_V6}/stages")
    override fun countPartnersPerStage(): StatsStagesResponse

    @GetExchange(value = "${ApiCommons.STATS_PATH_V6}/{stage}/address-types")
    override fun countAddressTypes(@PathVariable("stage") stage: StageType): StatsAddressTypesResponse

    @GetExchange(value = "${ApiCommons.STATS_PATH_V6}/confidence-criteria")
