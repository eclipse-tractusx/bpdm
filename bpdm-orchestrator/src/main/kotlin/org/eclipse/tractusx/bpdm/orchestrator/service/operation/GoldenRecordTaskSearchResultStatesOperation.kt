...
@Service
class GoldenRecordTaskSearchResultStatesOperation {

    fun search(parsed: List<GoldenRecordTaskSearchResultStatesParsed>): List<GoldenRecordTaskDb.ResultState?> {
        return parsed.map { it.task?.processingState?.resultState }
    }
}
