...
PageResponseSiteGateInputResponse ..> SiteGateInputResponse
SiteGateInputResponse ..> SiteState
SiteGateInputResponse ..> AddressGateInputResponse
...
class PageResponseSiteGateInputResponse{
+number: totalElements
+number: totalPages
+number: page
+number: contentSize
+SiteGateInputResponse[]: content;
}

class SiteGateInputResponse{
+string[]: nameParts
+string[]: roles
+string: externalId
+string: legalEntityExternalId
