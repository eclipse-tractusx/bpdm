...
LegalEntityGateOutputResponse ..> LegalEntityIdentifier
LegalEntityGateOutputResponse ..> LegalEntityState
LegalEntityGateOutputResponse ..> Classification
LegalEntityGateOutputResponse ..> AddressGateInputResponse
...
PageResponseLegalEntityGateOutputResponse ..> LegalEntityGateOutputResponse
...
class LegalEntityGateOutputResponse{
+string: legalShortName
+string: legalForm
+string[]: legalNameParts
+string[]: roles
...
class PageResponseLegalEntityGateOutputResponse{
+number: totalElements
+number: totalPages
+number: page
+number: contentSize
+LegalEntityGateOutputResponse[]: content;
}
