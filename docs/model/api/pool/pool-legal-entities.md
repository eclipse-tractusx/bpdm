...
LegalEntityPartnerUpdateRequest ..> LegalEntityIdentifier
LegalEntityPartnerUpdateRequest ..> LegalEntityState
LegalEntityPartnerUpdateRequest ..> Classification
LegalEntityPartnerUpdateRequest ..> LogisticAddressDto
...
class LegalEntityPartnerUpdateRequest{
+string: bpnl
+string: legalName
+string: legalShortName
+string: legalForm
