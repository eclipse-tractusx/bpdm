...
open class OrchestratorApiClientV6Impl(
    ...
    override val goldenRecordTasks by lazy { createClient<GoldenRecordTaskApiClientV6>() }

    override val finishedTaskEvents by lazy { createClient<FinishedTaskEventApiClientV6>() }
