...
@Schema(description = "Contains detailed information about the current processing state of a relations golden record task")
data class TaskProcessingRelationsStateDto(
