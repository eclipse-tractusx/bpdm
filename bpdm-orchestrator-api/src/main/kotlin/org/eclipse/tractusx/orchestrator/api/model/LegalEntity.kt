...
data class LegalEntity(
    ...
    override val classifications: Collection<LegalEntityClassification> = emptyList(),

    val legalAddress: LogisticAddress? = null,

    override val confidenceCriteria: ConfidenceCriteria? = null
